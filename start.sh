...
tmux new-session -d -s "CDHT" "./cdht.py 1 3 4 300 0.3"
tmux split-window -v "./cdht.py  3 4 5 300 0.3"
tmux split-window -h -t 0 "./cdht.py  10 12 15 300 0.3"
tmux split-window -h -t 1 "./cdht.py  12 15 1 300 0.3"
tmux split-window -h -t 0 "./cdht.py  15 1 3 300 0.3"
tmux split-window -h -t 4 "./cdht.py  4 5 8 300 0.3"
tmux split-window -h -t 5 "./cdht.py  5 8 10 300 0.3"
tmux split-window -h -t 4 "./cdht.py  8 10 12 300 0.3"
tmux a 
